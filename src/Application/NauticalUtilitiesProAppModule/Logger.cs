    ...
    internal static class Logger
    {
        ...
        static Logger() {
            ...
            configuration = configuration.WriteTo.File(
                    System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), @"NauticalUtilities", "NauticalUtilitiesProAppModule", "nauticalutilities-developer.log"),
